...
class BoardingActivity : AppCompatActivity() {
    ...
    private val slider_adapter= SliderAdapter(this,listOf(IntroSlide("Shopping","Go Around The World","https://www.techversantinfotech.com/wp-content/uploads/2017/02/Our-Services01-.png"),
