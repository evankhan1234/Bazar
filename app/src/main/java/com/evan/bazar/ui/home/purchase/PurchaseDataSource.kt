...
class PurchaseDataSource (val context: Context, val alertRepository: HomeRepository) :
    PageKeyedDataSource<Int, Purchase>() {

    var networkState: MutableLiveData<NetworkState> = MutableLiveData()
    var limitPost: LimitPost? = null
    override fun loadInitial(
        params: LoadInitialParams<Int>,
        callback: LoadInitialCallback<Int, Purchase>
    ) {
        Coroutines.main {
