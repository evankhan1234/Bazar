...
class CreateDeliveryFragment : Fragment(),KodeinAware,ICustomerOrderListListener ,IDeliveryPostListener,IDeleteListener,IDeleteIdListener,IItemClickListener{
    ...
    override fun onCreateView(
        ...
        btn_ok?.setOnClickListener {
            ...
            if (delivery_details.isNullOrEmpty() && paid_amount_text.isNullOrEmpty() && delivery_charge_text.isNullOrEmpty()  ) {
                ...
                viewModel.postDelivery(token!!,customer_id!!,order_id!!,discount!!,total_value!!,paid_amount!!,due_amount!!,total_value!!,2,invoice_number!!,currentDate!!,delivery_details!!,delivery_charge!!)
                ...
                viewModel.updateCustomerOrderStatus(token!!,order_id!!)
